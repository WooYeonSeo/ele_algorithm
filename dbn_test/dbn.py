...
def test_DBN(finetune_lr=0.1, pretraining_epochs=10,
             ...
             dataset='sevenLast.csv.pkl.gz', batch_size=10):
    """
    ...
    dbn = DBN(numpy_rng=numpy_rng, n_ins=1*7,
              hidden_layers_sizes=[7, 7, 7],
              n_outs=17)
...
def predict():
    ...
    print test_set_x[:1]
    predicted_values = predict_model(test_set_x[:1])
